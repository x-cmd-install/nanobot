...
合计: **403,344** 行代码（覆盖前 5 种语言、共 **1364** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Python | 241,149 | 4,204 | 44,411 | 769 |
| Tsx | 77,913 | 233 | 5,783 | 192 |
| Json | 41,181 | 0 | 4 | 201 |
| TypeScript | 40,106 | 768 | 3,599 | 201 |
| Css | 1,159 | 60 | 122 | 1 |
...
- **Star**: 48,431 · **Fork**: 8,556 · **开放 issue**: 1,502 · **贡献者**: 398

## 累计统计

- **发布数**: 20 · **已合并 PR**: 1741 · **开放 PR**: 573 · **已关闭 issue**: 1288 · **开放 issue**: 214 · **提交数**: 4502

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-22 | 1 | 186 | 77 | 23 | 23 | 274 |
| last60d | 2026-07-23 | 2 | 425 | 141 | 64 | 46 | 751 |
| 90d | 2026-06-23 | 3 | 666 | 180 | 168 | 62 | 1261 |
| last180d | 2026-03-25 | 10 | 1354 | 317 | 646 | 122 | 2852 |
| 360d | 2025-09-26 | 20 | 1741 | 573 | 1288 | 214 | 3856 |
| last720d | 2024-10-01 | 20 | 1741 | 573 | 1288 | 214 | 4502 |
...
nanobot 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `nanobot` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/nanobot.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260921.yml` · 2026-09-21T03:59:28Z._
